    ...
    return (
        <>
            ...
            <Page
                ...
                subTitle="Last updated: November 19, 2023"
            >
                <>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                ...
                                {process.env.NEXT_PUBLIC_SITE_NAME}, accessible
                                from{' '}
                                <a
                    ...
                    <SubTitle headingType={2}>Types of Data Collected</SubTitle>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>Address, State, Province, Postal code, City</p>
                        </li>
                        <li>
                            <p>Usage Data</p>
                        </li>
                    ...
                    <ul>
                        <li>
                            <p>By email: {process.env.NEXT_PUBLIC_EMAIL}</p>
                        </li>
                        <li>
                            <p>
                                By phone number:{' '}
...
function SubTitle({ children, headingType }: props): JSX.Element {
    return (
        <h3
            className={`${
                !headingType
